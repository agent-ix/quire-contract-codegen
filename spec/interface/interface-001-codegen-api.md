...
bound_strategy_slice:
  ...
  depends_on: FR-001-AC-8 bounded-integer oracle grammar (codegen#4, branch task/4-numeric-state-oracles revision 1db74b5); quire-contract-ir FR-012 through FR-015 and FR-023 at 04eb6f8; quire-contract-runtime FR-001, FR-003, FR-004 and interface-001 at 8a4d02b; quoin FR-064 and FR-068; implementation waits on codegen#4
  ...
  rates: the bound-strategy summary alone exposes discard_rate() and rejection_rate(), each Some((numerator, attempted)), or None at zero attempted or when the report snapshot is at_limit (quire-contract-runtime FR-004); the PR #22 harness summary is unchanged
