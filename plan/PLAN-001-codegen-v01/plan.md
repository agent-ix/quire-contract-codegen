...
| [Task-003](./tasks/Task-003-dependency-reconciliation.md) | Upstream dependency reconciliation | in_progress |
...
Task-004 must not start until Task-003 has a reviewed IR schema/corpus revision. Runtime and PGM-01
remain provisional inputs. Automation must not complete Task-007.
