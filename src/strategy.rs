...
\n\
/// Expected contract-domain classification for one generated enum case.\n\
#[derive(Clone, Copy, Debug, Eq, PartialEq)]\n\
pub enum {domain_type} {{\n\
    /// The enum case belongs to the declared membership.\n\
    Accepted,\n\
    /// The enum case must remain a reported precondition rejection.\n\
    Rejected,\n\
}}\n\
\n\
impl {domain_type} {{\n\
...
pub struct {case_type} {{\n\
    ...
    pub related: Option<{}>,\n\
    /// Whether the harness must accept or reject this enum case.\n\
    pub expected: {domain_type},\n\
}}\n\
\n\
