...
| Runtime helpers | `agent-ix/quire-contract-runtime#5` head `7f72129eb700eb5e26822e384521f7f85239fa5a` | rebased manual-CI draft; local gates pass, current remote run pending | reviewed/merged source tag, public API and feature reconciliation |
