...
| Runtime helpers | `agent-ix/quire-contract-runtime#5` head `534691f5c8f21fd2457118a83add96cc2e265b49` | source-review candidate; corrected PGM-01 evidence passes locally, current remote run pending | reviewed/merged source tag, public API and feature reconciliation |
