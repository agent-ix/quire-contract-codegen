...
if [[ $# -gt 0 ]]; then
  ...
  final_evidence_dir="evidence/foundation-${evidence_revision}-${evidence_timestamp}"
fi
...
' "$evidence_dir"
retain_collection
echo "collected and verified $final_evidence_dir; update evidence/ANCHORS as a separate review-boundary step"
